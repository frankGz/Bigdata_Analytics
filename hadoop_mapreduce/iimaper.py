...
for line in sys.stdin:
	filtered = []
	terms = line.split('.', 1) #seperate id and value (lyrics is the value)
	songID = terms[0]
	wd_tokens = tokenize(terms[1])
	for w in wd_tokens:
